...
namespace EQEmu_Patcher
{
    ...
    class UtilityLibrary
    {
        ...
        {
            var basePath = Path.GetFullPath(Path.GetDirectoryName(Application.ExecutablePath) + Path.DirectorySeparatorChar);
            var absPath = Path.GetFullPath(path);
            return absPath.StartsWith(basePath, StringComparison.OrdinalIgnoreCase);
        }
    }
}
