...
-- All Features: Live Items heirloom/global helpers.
...
local function live_items_handle_command(e)
...
local function live_items_on_level_up(e)
	if not live_items_enabled() then
		return
	end
...
function event_command(e)
	if live_items_handle_command and live_items_handle_command(e) == 1 then
		return 1
	end
...
function event_level_up(e)
  if live_items_on_level_up then
    live_items_on_level_up(e)
  end
