...
namespace EQ
{
	...
	public:
		...
		bool SwapItemByClassMask(int16 source_slot, int16 destination_slot, SwapItemFailState& fail_state, uint16 race_id, uint32 class_mask, uint32 deity_id = Deity::Unknown, uint8 level = 0);
