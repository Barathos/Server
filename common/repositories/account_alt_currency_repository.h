...
public:
     ...
     *
     * AccountAltCurrencyRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * AccountAltCurrencyRepository::GetWhereNeverExpires()
     * AccountAltCurrencyRepository::GetWhereXAndY()
     * AccountAltCurrencyRepository::DeleteWhereXAndY()
     *
